...
Date: 2025-11-16 14:36:15
LastEditors: Zhang-sklda 845603757@qq.com
LastEditTime: 2025-11-16 16:40:16
FilePath: /kuka_iiwa_mujoco_tutorial/dsakl.py
...
with mujoco.viewer.launch_passive(model=model,data=data) as viewer:
    ...
    while viewer.is_running():
        ...
        error_pos[:] = data.site(site_id).xpos - data.mocap_pos[mocap_id]#方向是末端 - 目标，所以是负反馈
